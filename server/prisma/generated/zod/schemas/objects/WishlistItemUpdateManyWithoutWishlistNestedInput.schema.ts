...
const Schema: z.ZodType<Prisma.WishlistItemUpdateManyWithoutWishlistNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const WishlistItemUpdateManyWithoutWishlistNestedInputObjectSchema =
  Schema;
