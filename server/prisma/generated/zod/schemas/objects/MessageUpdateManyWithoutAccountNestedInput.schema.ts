...
const Schema: z.ZodType<Prisma.MessageUpdateManyWithoutAccountNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => MessageUpdateManyWithWhereWithoutAccountInputObjectSchema),
        z
          .lazy(() => MessageUpdateManyWithWhereWithoutAccountInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const MessageUpdateManyWithoutAccountNestedInputObjectSchema = Schema;
