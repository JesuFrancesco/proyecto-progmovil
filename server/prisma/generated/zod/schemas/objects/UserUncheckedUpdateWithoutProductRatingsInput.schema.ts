...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutProductRatingsInput> =
  z
    .object({
      id: z
        .union([
      ...
      wishlists: z
        .lazy(
          () => WishlistUncheckedUpdateManyWithoutUserNestedInputObjectSchema,
        )
        .optional(),
      orders: z
...
export const UserUncheckedUpdateWithoutProductRatingsInputObjectSchema = Schema;
