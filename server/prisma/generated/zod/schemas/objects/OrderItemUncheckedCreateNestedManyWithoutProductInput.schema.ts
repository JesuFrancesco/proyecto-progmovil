...
const Schema: z.ZodType<Prisma.OrderItemUncheckedCreateNestedManyWithoutProductInput> =
  z
    .object({
      create: z
        .union([
...
export const OrderItemUncheckedCreateNestedManyWithoutProductInputObjectSchema =
  Schema;
