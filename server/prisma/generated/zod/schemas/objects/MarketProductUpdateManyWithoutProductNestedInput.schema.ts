...
const Schema: z.ZodType<Prisma.MarketProductUpdateManyWithoutProductNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const MarketProductUpdateManyWithoutProductNestedInputObjectSchema =
  Schema;
