    ...
    children: [
      Expanded(
        child: Column(
          ...
          children: [
            Text("Preguntas", style:TextStyle(fontWeight: FontWeight.bold, fontSize: 20),),
          ...
          Text("Resenas", style:TextStyle(fontWeight: FontWeight.bold, fontSize: 20),),
          ...
          Row(
            ...
            Row(children: [
              ...
              Icon(Icons.star, color: Colors.yellow,),
              10.ph,
              Text("Excelente manga", style: TextStyle(fontWeight: FontWeight.bold),),
            ],),
