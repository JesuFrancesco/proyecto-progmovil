...
const Schema: z.ZodType<Prisma.OrderItemUpdateManyWithWhereWithoutOrderInput> =
  z
    .object({
...
export const OrderItemUpdateManyWithWhereWithoutOrderInputObjectSchema = Schema;
