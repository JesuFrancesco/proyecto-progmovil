...
const Schema: z.ZodType<Prisma.ProductRatingUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductRatingUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
