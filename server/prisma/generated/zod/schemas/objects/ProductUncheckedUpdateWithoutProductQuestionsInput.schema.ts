...
import { ProductAttachmentUncheckedUpdateManyWithoutProductNestedInputObjectSchema } from './ProductAttachmentUncheckedUpdateManyWithoutProductNestedInput.schema';
...
const Schema: z.ZodType<Prisma.ProductUncheckedUpdateWithoutProductQuestionsInput> =
  z
    .object({
      id: z
        .union([
      ...
      productAttachments: z
        .lazy(
          () =>
            ProductAttachmentUncheckedUpdateManyWithoutProductNestedInputObjectSchema,
        )
        .optional(),
      productTags: z
        .lazy(
...
export const ProductUncheckedUpdateWithoutProductQuestionsInputObjectSchema =
  Schema;
