...
import { CartItemUpdateManyWithoutProductNestedInputObjectSchema } from './CartItemUpdateManyWithoutProductNestedInput.schema';
...
const Schema: z.ZodType<Prisma.ProductUpdateWithoutProductAttachmentsInput> = z
  .object({
    name: z
      .union([
        z.string(),
    ...
    productQuestions: z
      ...
      .optional(),
    cartItems: z
      .lazy(() => CartItemUpdateManyWithoutProductNestedInputObjectSchema)
      .optional(),
    wishlistItems: z
...
export const ProductUpdateWithoutProductAttachmentsInputObjectSchema = Schema;
