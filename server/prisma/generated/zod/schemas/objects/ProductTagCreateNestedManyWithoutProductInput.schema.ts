...
const Schema: z.ZodType<Prisma.ProductTagCreateNestedManyWithoutProductInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductTagCreateNestedManyWithoutProductInputObjectSchema = Schema;
