...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutProductRatingsInput> =
  z
    .object({
...
export const UserUncheckedCreateWithoutProductRatingsInputObjectSchema = Schema;
