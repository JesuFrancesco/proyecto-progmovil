...
const Schema: z.ZodType<Prisma.QuestionReplyUncheckedCreateNestedManyWithoutProductQuestionInput> =
  z
    .object({
      create: z
        .union([
...
export const QuestionReplyUncheckedCreateNestedManyWithoutProductQuestionInputObjectSchema =
  Schema;
