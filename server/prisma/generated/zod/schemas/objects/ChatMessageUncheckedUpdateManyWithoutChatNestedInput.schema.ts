...
const Schema: z.ZodType<Prisma.ChatMessageUncheckedUpdateManyWithoutChatNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ChatMessageUncheckedUpdateManyWithoutChatNestedInputObjectSchema =
  Schema;
