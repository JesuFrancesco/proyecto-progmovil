...
const Schema: z.ZodType<Prisma.UserUpdateManyWithoutDistritoNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => UserUpsertWithWhereUniqueWithoutDistritoInputObjectSchema),
        z
          .lazy(() => UserUpsertWithWhereUniqueWithoutDistritoInputObjectSchema)
          .array(),
      ])
      .optional(),
    set: z
    ...
    update: z
      .union([
        z.lazy(() => UserUpdateWithWhereUniqueWithoutDistritoInputObjectSchema),
        z
          .lazy(() => UserUpdateWithWhereUniqueWithoutDistritoInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const UserUpdateManyWithoutDistritoNestedInputObjectSchema = Schema;
