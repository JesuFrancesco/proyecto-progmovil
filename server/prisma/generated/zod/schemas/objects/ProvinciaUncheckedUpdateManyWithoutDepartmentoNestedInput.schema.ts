...
const Schema: z.ZodType<Prisma.ProvinciaUncheckedUpdateManyWithoutDepartmentoNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProvinciaUncheckedUpdateManyWithoutDepartmentoNestedInputObjectSchema =
  Schema;
