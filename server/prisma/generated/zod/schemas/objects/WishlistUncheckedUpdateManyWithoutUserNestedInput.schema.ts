...
const Schema: z.ZodType<Prisma.WishlistUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => WishlistUpsertWithWhereUniqueWithoutUserInputObjectSchema,
          ),
          z
            .lazy(
              () => WishlistUpsertWithWhereUniqueWithoutUserInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => WishlistUpdateWithWhereUniqueWithoutUserInputObjectSchema,
          ),
          z
            .lazy(
              () => WishlistUpdateWithWhereUniqueWithoutUserInputObjectSchema,
...
export const WishlistUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
