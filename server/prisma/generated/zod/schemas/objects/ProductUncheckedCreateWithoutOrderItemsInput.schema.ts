...
const Schema: z.ZodType<Prisma.ProductUncheckedCreateWithoutOrderItemsInput> = z
  .object({
...
export const ProductUncheckedCreateWithoutOrderItemsInputObjectSchema = Schema;
