...
const Schema: z.ZodType<Prisma.DistritoUncheckedUpdateManyWithoutProvinciaNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const DistritoUncheckedUpdateManyWithoutProvinciaNestedInputObjectSchema =
  Schema;
