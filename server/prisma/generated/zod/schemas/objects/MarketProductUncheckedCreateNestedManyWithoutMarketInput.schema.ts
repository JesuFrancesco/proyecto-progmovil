...
const Schema: z.ZodType<Prisma.MarketProductUncheckedCreateNestedManyWithoutMarketInput> =
  z
    .object({
      create: z
        .union([
...
export const MarketProductUncheckedCreateNestedManyWithoutMarketInputObjectSchema =
  Schema;
