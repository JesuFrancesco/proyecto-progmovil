...
const Schema: z.ZodType<Prisma.MessageAttachmentUpdateManyWithoutMessageNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const MessageAttachmentUpdateManyWithoutMessageNestedInputObjectSchema =
  Schema;
