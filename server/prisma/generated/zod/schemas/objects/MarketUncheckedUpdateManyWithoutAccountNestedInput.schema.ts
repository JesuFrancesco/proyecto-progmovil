...
const Schema: z.ZodType<Prisma.MarketUncheckedUpdateManyWithoutAccountNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => MarketUpdateManyWithWhereWithoutAccountInputObjectSchema,
          ),
          z
            .lazy(
              () => MarketUpdateManyWithWhereWithoutAccountInputObjectSchema,
...
export const MarketUncheckedUpdateManyWithoutAccountNestedInputObjectSchema =
  Schema;
