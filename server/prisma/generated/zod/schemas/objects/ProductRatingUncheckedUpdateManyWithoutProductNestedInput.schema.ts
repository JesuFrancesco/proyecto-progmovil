...
const Schema: z.ZodType<Prisma.ProductRatingUncheckedUpdateManyWithoutProductNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductRatingUncheckedUpdateManyWithoutProductNestedInputObjectSchema =
  Schema;
