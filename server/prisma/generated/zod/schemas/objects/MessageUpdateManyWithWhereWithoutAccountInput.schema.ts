...
const Schema: z.ZodType<Prisma.MessageUpdateManyWithWhereWithoutAccountInput> =
  z
    .object({
...
export const MessageUpdateManyWithWhereWithoutAccountInputObjectSchema = Schema;
