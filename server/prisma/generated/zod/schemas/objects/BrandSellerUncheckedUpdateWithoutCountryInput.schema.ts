...
const Schema: z.ZodType<Prisma.BrandSellerUncheckedUpdateWithoutCountryInput> =
  z
    .object({
      id: z
        .union([
...
export const BrandSellerUncheckedUpdateWithoutCountryInputObjectSchema = Schema;
