...
const Schema: z.ZodType<Prisma.ProductQuestionUpdateManyWithWhereWithoutProductInput> =
  z
    .object({
...
export const ProductQuestionUpdateManyWithWhereWithoutProductInputObjectSchema =
  Schema;
