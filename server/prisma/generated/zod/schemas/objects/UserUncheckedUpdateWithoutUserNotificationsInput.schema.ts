...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutUserNotificationsInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutUserNotificationsInputObjectSchema =
  Schema;
