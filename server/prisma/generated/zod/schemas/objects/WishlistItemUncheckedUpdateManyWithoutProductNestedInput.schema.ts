...
const Schema: z.ZodType<Prisma.WishlistItemUncheckedUpdateManyWithoutProductNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const WishlistItemUncheckedUpdateManyWithoutProductNestedInputObjectSchema =
  Schema;
