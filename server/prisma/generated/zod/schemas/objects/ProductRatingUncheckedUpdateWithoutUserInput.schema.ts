...
const Schema: z.ZodType<Prisma.ProductRatingUncheckedUpdateWithoutUserInput> = z
  .object({
    id: z
      .union([
        z.number(),
...
export const ProductRatingUncheckedUpdateWithoutUserInputObjectSchema = Schema;
