...
const Schema: z.ZodType<Prisma.UserUpdateManyWithoutProvinciaNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => UserUpdateManyWithWhereWithoutProvinciaInputObjectSchema),
        z
          .lazy(() => UserUpdateManyWithWhereWithoutProvinciaInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const UserUpdateManyWithoutProvinciaNestedInputObjectSchema = Schema;
