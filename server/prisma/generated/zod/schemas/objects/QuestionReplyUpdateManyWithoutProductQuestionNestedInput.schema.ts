...
const Schema: z.ZodType<Prisma.QuestionReplyUpdateManyWithoutProductQuestionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const QuestionReplyUpdateManyWithoutProductQuestionNestedInputObjectSchema =
  Schema;
