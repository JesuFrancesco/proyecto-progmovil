...
const Schema: z.ZodType<Prisma.UserUpdateManyWithoutDepartmentoNestedInput> = z
  .object({
    create: z
      .union([
...
export const UserUpdateManyWithoutDepartmentoNestedInputObjectSchema = Schema;
