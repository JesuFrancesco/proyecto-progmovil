...
const Schema: z.ZodType<Prisma.WishlistItemCreateNestedManyWithoutWishlistInput> =
  z
    .object({
      create: z
        .union([
...
export const WishlistItemCreateNestedManyWithoutWishlistInputObjectSchema =
  Schema;
