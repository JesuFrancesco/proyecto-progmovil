...
const Schema: z.ZodType<Prisma.ProductQuestionUncheckedCreateNestedManyWithoutProductInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductQuestionUncheckedCreateNestedManyWithoutProductInputObjectSchema =
  Schema;
