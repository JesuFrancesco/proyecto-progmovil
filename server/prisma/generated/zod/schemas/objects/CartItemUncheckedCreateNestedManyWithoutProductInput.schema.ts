...
const Schema: z.ZodType<Prisma.CartItemUncheckedCreateNestedManyWithoutProductInput> =
  z
    .object({
      create: z
        .union([
...
export const CartItemUncheckedCreateNestedManyWithoutProductInputObjectSchema =
  Schema;
