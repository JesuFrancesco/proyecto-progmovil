...
const Schema: z.ZodType<Prisma.ProductUncheckedCreateWithoutProductAttachmentsInput> =
  z
    .object({
...
export const ProductUncheckedCreateWithoutProductAttachmentsInputObjectSchema =
  Schema;
