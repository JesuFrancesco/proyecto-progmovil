...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutShoppingCartsInput> = z
  .object({
    id: z
      .union([
        z.number(),
...
export const UserUncheckedUpdateWithoutShoppingCartsInputObjectSchema = Schema;
