...
const Schema: z.ZodType<Prisma.MarketProductCreateNestedManyWithoutProductInput> =
  z
    .object({
      create: z
        .union([
...
export const MarketProductCreateNestedManyWithoutProductInputObjectSchema =
  Schema;
