...
const Schema: z.ZodType<Prisma.MarketProductUpdateManyWithWhereWithoutProductInput> =
  z
    .object({
...
export const MarketProductUpdateManyWithWhereWithoutProductInputObjectSchema =
  Schema;
