...
const Schema: z.ZodType<Prisma.ProductUncheckedUpdateWithoutProductRatingsInput> =
  z
    .object({
      id: z
        .union([
...
export const ProductUncheckedUpdateWithoutProductRatingsInputObjectSchema =
  Schema;
