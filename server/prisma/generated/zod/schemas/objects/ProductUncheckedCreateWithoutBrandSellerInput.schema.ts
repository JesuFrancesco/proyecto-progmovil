...
const Schema: z.ZodType<Prisma.ProductUncheckedCreateWithoutBrandSellerInput> =
  z
    .object({
...
export const ProductUncheckedCreateWithoutBrandSellerInputObjectSchema = Schema;
