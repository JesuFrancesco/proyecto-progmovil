...
const Schema: z.ZodType<Prisma.ChatMessageUncheckedCreateNestedManyWithoutMessageInput> =
  z
    .object({
      create: z
        .union([
...
export const ChatMessageUncheckedCreateNestedManyWithoutMessageInputObjectSchema =
  Schema;
