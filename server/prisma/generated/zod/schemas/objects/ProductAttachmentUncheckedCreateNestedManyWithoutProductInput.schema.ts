...
const Schema: z.ZodType<Prisma.ProductAttachmentUncheckedCreateNestedManyWithoutProductInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductAttachmentUncheckedCreateNestedManyWithoutProductInputObjectSchema =
  Schema;
