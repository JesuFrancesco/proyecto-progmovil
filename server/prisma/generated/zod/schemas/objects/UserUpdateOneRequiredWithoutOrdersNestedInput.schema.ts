...
const Schema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutOrdersNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const UserUpdateOneRequiredWithoutOrdersNestedInputObjectSchema = Schema;
