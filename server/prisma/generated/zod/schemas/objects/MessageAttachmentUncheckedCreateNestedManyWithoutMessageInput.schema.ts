...
const Schema: z.ZodType<Prisma.MessageAttachmentUncheckedCreateNestedManyWithoutMessageInput> =
  z
    .object({
      create: z
        .union([
...
export const MessageAttachmentUncheckedCreateNestedManyWithoutMessageInputObjectSchema =
  Schema;
