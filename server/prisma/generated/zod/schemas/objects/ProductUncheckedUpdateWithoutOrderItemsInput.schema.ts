...
const Schema: z.ZodType<Prisma.ProductUncheckedUpdateWithoutOrderItemsInput> = z
  .object({
    id: z
      .union([
        z.number(),
...
export const ProductUncheckedUpdateWithoutOrderItemsInputObjectSchema = Schema;
