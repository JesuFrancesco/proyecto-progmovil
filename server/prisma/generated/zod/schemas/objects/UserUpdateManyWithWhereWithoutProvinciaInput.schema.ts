...
const Schema: z.ZodType<Prisma.UserUpdateManyWithWhereWithoutProvinciaInput> = z
  .object({
...
export const UserUpdateManyWithWhereWithoutProvinciaInputObjectSchema = Schema;
