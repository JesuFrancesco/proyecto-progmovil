...
const Schema: z.ZodType<Prisma.UserUpdateManyWithWhereWithoutDistritoInput> = z
  .object({
...
export const UserUpdateManyWithWhereWithoutDistritoInputObjectSchema = Schema;
