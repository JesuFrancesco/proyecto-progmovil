...
const Schema: z.ZodType<Prisma.CartItemUpdateManyWithoutShoppingCartNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const CartItemUpdateManyWithoutShoppingCartNestedInputObjectSchema =
  Schema;
