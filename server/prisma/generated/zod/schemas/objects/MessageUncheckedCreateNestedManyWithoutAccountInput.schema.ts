...
const Schema: z.ZodType<Prisma.MessageUncheckedCreateNestedManyWithoutAccountInput> =
  z
    .object({
      create: z
        .union([
...
export const MessageUncheckedCreateNestedManyWithoutAccountInputObjectSchema =
  Schema;
