...
const Schema: z.ZodType<Prisma.ProductUncheckedCreateNestedManyWithoutBrandSellerInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductUncheckedCreateNestedManyWithoutBrandSellerInputObjectSchema =
  Schema;
