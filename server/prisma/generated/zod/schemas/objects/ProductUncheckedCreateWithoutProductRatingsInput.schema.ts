...
const Schema: z.ZodType<Prisma.ProductUncheckedCreateWithoutProductRatingsInput> =
  z
    .object({
...
export const ProductUncheckedCreateWithoutProductRatingsInputObjectSchema =
  Schema;
