...
const Schema: z.ZodType<Prisma.ProductTagUncheckedUpdateManyWithoutTagNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => ProductTagUpdateManyWithWhereWithoutTagInputObjectSchema,
          ),
          z
            .lazy(
              () => ProductTagUpdateManyWithWhereWithoutTagInputObjectSchema,
...
export const ProductTagUncheckedUpdateManyWithoutTagNestedInputObjectSchema =
  Schema;
