...
const Schema: z.ZodType<Prisma.ProductQuestionUpdateManyWithoutProductNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductQuestionUpdateManyWithoutProductNestedInputObjectSchema =
  Schema;
