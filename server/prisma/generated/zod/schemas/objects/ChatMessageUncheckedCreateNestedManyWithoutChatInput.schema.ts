...
const Schema: z.ZodType<Prisma.ChatMessageUncheckedCreateNestedManyWithoutChatInput> =
  z
    .object({
      create: z
        .union([
...
export const ChatMessageUncheckedCreateNestedManyWithoutChatInputObjectSchema =
  Schema;
