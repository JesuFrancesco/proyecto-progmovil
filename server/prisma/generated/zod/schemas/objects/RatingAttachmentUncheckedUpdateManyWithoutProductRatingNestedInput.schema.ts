...
const Schema: z.ZodType<Prisma.RatingAttachmentUncheckedUpdateManyWithoutProductRatingNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const RatingAttachmentUncheckedUpdateManyWithoutProductRatingNestedInputObjectSchema =
  Schema;
