...
const Schema: z.ZodType<Prisma.ShoppingCartUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ShoppingCartUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
