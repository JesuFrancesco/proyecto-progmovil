...
const Schema: z.ZodType<Prisma.BrandSellerUncheckedUpdateManyWithoutCountryNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BrandSellerUncheckedUpdateManyWithoutCountryNestedInputObjectSchema =
  Schema;
