...
const Schema: z.ZodType<Prisma.ProductUncheckedUpdateWithoutMarketProductsInput> =
  z
    .object({
      id: z
        .union([
...
export const ProductUncheckedUpdateWithoutMarketProductsInputObjectSchema =
  Schema;
