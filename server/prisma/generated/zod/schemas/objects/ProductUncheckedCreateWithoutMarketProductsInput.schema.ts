...
const Schema: z.ZodType<Prisma.ProductUncheckedCreateWithoutMarketProductsInput> =
  z
    .object({
...
export const ProductUncheckedCreateWithoutMarketProductsInputObjectSchema =
  Schema;
