...
const Schema: z.ZodType<Prisma.ChatParticipantUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ChatParticipantUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
