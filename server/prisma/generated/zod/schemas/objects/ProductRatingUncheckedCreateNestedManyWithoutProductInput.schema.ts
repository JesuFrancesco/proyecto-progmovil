...
const Schema: z.ZodType<Prisma.ProductRatingUncheckedCreateNestedManyWithoutProductInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductRatingUncheckedCreateNestedManyWithoutProductInputObjectSchema =
  Schema;
