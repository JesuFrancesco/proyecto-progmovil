...
const Schema: z.ZodType<Prisma.ChatParticipantUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const ChatParticipantUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
