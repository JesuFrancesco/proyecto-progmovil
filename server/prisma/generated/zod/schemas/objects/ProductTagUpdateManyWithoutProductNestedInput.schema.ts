...
const Schema: z.ZodType<Prisma.ProductTagUpdateManyWithoutProductNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductTagUpdateManyWithoutProductNestedInputObjectSchema = Schema;
