...
const Schema: z.ZodType<Prisma.ProductUncheckedUpdateWithoutProductTagsInput> =
  z
    .object({
      id: z
        .union([
...
export const ProductUncheckedUpdateWithoutProductTagsInputObjectSchema = Schema;
