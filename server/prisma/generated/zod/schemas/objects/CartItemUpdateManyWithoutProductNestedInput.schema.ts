...
const Schema: z.ZodType<Prisma.CartItemUpdateManyWithoutProductNestedInput> = z
  .object({
    create: z
      .union([
...
export const CartItemUpdateManyWithoutProductNestedInputObjectSchema = Schema;
