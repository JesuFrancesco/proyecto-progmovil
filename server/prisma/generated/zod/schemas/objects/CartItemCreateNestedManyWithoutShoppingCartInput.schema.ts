...
const Schema: z.ZodType<Prisma.CartItemCreateNestedManyWithoutShoppingCartInput> =
  z
    .object({
      create: z
        .union([
...
export const CartItemCreateNestedManyWithoutShoppingCartInputObjectSchema =
  Schema;
