...
const Schema: z.ZodType<Prisma.UserNotificationUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const UserNotificationUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
