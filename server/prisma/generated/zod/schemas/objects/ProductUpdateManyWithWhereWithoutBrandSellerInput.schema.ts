...
const Schema: z.ZodType<Prisma.ProductUpdateManyWithWhereWithoutBrandSellerInput> =
  z
    .object({
...
export const ProductUpdateManyWithWhereWithoutBrandSellerInputObjectSchema =
  Schema;
