...
const Schema: z.ZodType<Prisma.BrandSellerUncheckedCreateNestedManyWithoutCountryInput> =
  z
    .object({
      create: z
        .union([
...
export const BrandSellerUncheckedCreateNestedManyWithoutCountryInputObjectSchema =
  Schema;
