...
const Schema: z.ZodType<Prisma.OrderItemUpdateManyWithoutProductNestedInput> = z
  .object({
    create: z
      .union([
...
export const OrderItemUpdateManyWithoutProductNestedInputObjectSchema = Schema;
