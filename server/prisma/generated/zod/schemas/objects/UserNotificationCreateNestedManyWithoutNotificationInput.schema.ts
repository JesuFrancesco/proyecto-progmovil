...
const Schema: z.ZodType<Prisma.UserNotificationCreateNestedManyWithoutNotificationInput> =
  z
    .object({
      create: z
        .union([
...
export const UserNotificationCreateNestedManyWithoutNotificationInputObjectSchema =
  Schema;
