...
const Schema: z.ZodType<Prisma.ShoppingCartCreateNestedManyWithoutUserInput> = z
  .object({
    create: z
      .union([
...
export const ShoppingCartCreateNestedManyWithoutUserInputObjectSchema = Schema;
