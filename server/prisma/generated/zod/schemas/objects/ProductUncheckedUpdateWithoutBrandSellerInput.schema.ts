...
const Schema: z.ZodType<Prisma.ProductUncheckedUpdateWithoutBrandSellerInput> =
  z
    .object({
      id: z
        .union([
...
export const ProductUncheckedUpdateWithoutBrandSellerInputObjectSchema = Schema;
