...
const Schema: z.ZodType<Prisma.ProductTagUpdateManyWithWhereWithoutProductInput> =
  z
    .object({
...
export const ProductTagUpdateManyWithWhereWithoutProductInputObjectSchema =
  Schema;
