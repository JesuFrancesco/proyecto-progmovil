...
const Schema: z.ZodType<Prisma.UserNotificationUpdateManyWithWhereWithoutUserInput> =
  z
    .object({
...
export const UserNotificationUpdateManyWithWhereWithoutUserInputObjectSchema =
  Schema;
