...
const Schema: z.ZodType<Prisma.WishlistItemUpdateManyWithWhereWithoutProductInput> =
  z
    .object({
...
export const WishlistItemUpdateManyWithWhereWithoutProductInputObjectSchema =
  Schema;
