...
const Schema: z.ZodType<Prisma.UserCreateNestedManyWithoutDepartmentoInput> = z
  .object({
    create: z
      .union([
...
export const UserCreateNestedManyWithoutDepartmentoInputObjectSchema = Schema;
