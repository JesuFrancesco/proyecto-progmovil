...
const Schema: z.ZodType<Prisma.OrderItemUpdateManyWithoutOrderNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => OrderItemUpdateManyWithWhereWithoutOrderInputObjectSchema),
        z
          .lazy(() => OrderItemUpdateManyWithWhereWithoutOrderInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const OrderItemUpdateManyWithoutOrderNestedInputObjectSchema = Schema;
