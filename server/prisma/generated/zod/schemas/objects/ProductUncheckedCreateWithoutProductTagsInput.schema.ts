...
const Schema: z.ZodType<Prisma.ProductUncheckedCreateWithoutProductTagsInput> =
  z
    .object({
...
export const ProductUncheckedCreateWithoutProductTagsInputObjectSchema = Schema;
