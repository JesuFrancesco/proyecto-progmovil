...
const Schema: z.ZodType<Prisma.MessageUpdateWithoutMessageAttachmentsInput> = z
  .object({
    text: z
      .union([
        z.string(),
...
export const MessageUpdateWithoutMessageAttachmentsInputObjectSchema = Schema;
