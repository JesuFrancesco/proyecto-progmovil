...
const Schema: z.ZodType<Prisma.UserNotificationUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const UserNotificationUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
