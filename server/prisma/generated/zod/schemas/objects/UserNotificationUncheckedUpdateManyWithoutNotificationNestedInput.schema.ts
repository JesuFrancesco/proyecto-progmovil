...
const Schema: z.ZodType<Prisma.UserNotificationUncheckedUpdateManyWithoutNotificationNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const UserNotificationUncheckedUpdateManyWithoutNotificationNestedInputObjectSchema =
  Schema;
