...
const Schema: z.ZodType<Prisma.ProductRatingUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductRatingUpdateManyWithoutUserNestedInputObjectSchema = Schema;
