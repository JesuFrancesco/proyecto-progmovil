...
const Schema: z.ZodType<Prisma.ProductAttachmentUpdateManyWithoutProductNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductAttachmentUpdateManyWithoutProductNestedInputObjectSchema =
  Schema;
