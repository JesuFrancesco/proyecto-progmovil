...
const Schema: z.ZodType<Prisma.ProductUncheckedUpdateManyWithoutBrandSellerNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductUncheckedUpdateManyWithoutBrandSellerNestedInputObjectSchema =
  Schema;
