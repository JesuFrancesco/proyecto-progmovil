...
const Schema: z.ZodType<Prisma.ProductUncheckedUpdateWithoutCartItemsInput> = z
  .object({
    id: z
      .union([
        z.number(),
...
export const ProductUncheckedUpdateWithoutCartItemsInputObjectSchema = Schema;
