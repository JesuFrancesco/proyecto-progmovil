...
const Schema: z.ZodType<Prisma.RatingAttachmentUncheckedCreateNestedManyWithoutProductRatingInput> =
  z
    .object({
      create: z
        .union([
...
export const RatingAttachmentUncheckedCreateNestedManyWithoutProductRatingInputObjectSchema =
  Schema;
