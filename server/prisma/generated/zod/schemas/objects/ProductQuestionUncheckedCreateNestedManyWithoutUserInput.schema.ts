...
const Schema: z.ZodType<Prisma.ProductQuestionUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductQuestionUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
