...
const Schema: z.ZodType<Prisma.ProductCreateWithoutProductAttachmentsInput> = z
  .object({
    name: z.string(),
    stock: z.number(),
    price: z.number(),
...
export const ProductCreateWithoutProductAttachmentsInputObjectSchema = Schema;
