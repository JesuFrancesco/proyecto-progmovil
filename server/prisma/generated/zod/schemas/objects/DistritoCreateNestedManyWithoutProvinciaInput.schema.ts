...
const Schema: z.ZodType<Prisma.DistritoCreateNestedManyWithoutProvinciaInput> =
  z
    .object({
      create: z
        .union([
...
export const DistritoCreateNestedManyWithoutProvinciaInputObjectSchema = Schema;
