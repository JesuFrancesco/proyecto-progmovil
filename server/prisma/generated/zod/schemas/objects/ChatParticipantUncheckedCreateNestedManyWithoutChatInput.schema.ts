...
const Schema: z.ZodType<Prisma.ChatParticipantUncheckedCreateNestedManyWithoutChatInput> =
  z
    .object({
      create: z
        .union([
...
export const ChatParticipantUncheckedCreateNestedManyWithoutChatInputObjectSchema =
  Schema;
