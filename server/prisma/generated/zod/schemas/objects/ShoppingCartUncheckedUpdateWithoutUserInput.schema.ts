...
const Schema: z.ZodType<Prisma.ShoppingCartUncheckedUpdateWithoutUserInput> = z
  .object({
    id: z
      .union([
        z.number(),
...
export const ShoppingCartUncheckedUpdateWithoutUserInputObjectSchema = Schema;
