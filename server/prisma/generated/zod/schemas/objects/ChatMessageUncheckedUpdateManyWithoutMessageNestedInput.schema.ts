...
const Schema: z.ZodType<Prisma.ChatMessageUncheckedUpdateManyWithoutMessageNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ChatMessageUncheckedUpdateManyWithoutMessageNestedInputObjectSchema =
  Schema;
