...
const Schema: z.ZodType<Prisma.ProvinciaUncheckedCreateNestedManyWithoutDepartmentoInput> =
  z
    .object({
      create: z
        .union([
...
export const ProvinciaUncheckedCreateNestedManyWithoutDepartmentoInputObjectSchema =
  Schema;
